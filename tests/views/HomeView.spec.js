...
describe('(View) Home', function viewHome() {
  let _component;
  let _rendered;
  let _props;
  let _spies;
  ...
  it('Should render as a <div>.', function renderAsDiv() {
    expect(_component.type).to.equal('div');
  });

  it('Should include an <h1> with welcome text.', function includeH1() {
  ...
  it('Should render with an <h2> that includes Sample Counter text.', function renderH2() {
  ...
  it('Should render props.counter at the end of the sample counter <h2>.', function renderProps() {
  ...
  describe('An increment button...', function incrementBtn() {
    let _btn;
    ...
    it('should be rendered.', function btnRendered() {
      expect(_btn).to.exist;
    });

    it('should dispatch an action when clicked.', function dispatchWhenClicked() {
  ...
  describe('A Double (Async) button...', function asyncButton() {
    let _btn;
    ...
    it('should be rendered.', function shouldRender() {
      expect(_btn).to.exist;
    });
